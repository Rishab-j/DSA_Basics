...
class hashMap< K, V >{
    ...
    private int size;
    private LinkedList<HMnode>[] buckets; // linkedlist type ka array
    ...
    private int findInBucket( int bi , K key){
        int ki = 0;
        LinkedList<HMnode> clist = buckets[bi]; // linked list store hogyi 
    ...
    private void rehash(){
        LinkedList<HMnode>[] oldBuckets = this.buckets; // reserve old data 
        this.buckets = new LinkedList[ 2 * oldBuckets.length ]; // make a new hash table of double length
    ...
    public void put( K key, V value ){
        ...
        int ki = findInBucket( bi, key ); // key index in the linkedlist 
